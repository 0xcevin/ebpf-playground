...
type trace_legacyProgramSpecs struct {
	...
	KretprobeSysExecve         *ebpf.ProgramSpec `ebpf:"kretprobe__sys_execve"`
...
type trace_legacyPrograms struct {
	...
	KretprobeSysExecve         *ebpf.Program `ebpf:"kretprobe__sys_execve"`
...
//
//go:embed trace_legacy_arm64_bpfel.o
