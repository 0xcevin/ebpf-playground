...
**核心特性**：运行时自动检测内核版本，≥ 5.8 使用高性能 **ringbuf + BTF/CO-RE** 现代模式，< 5.8 自动降级到 **perf buffer** 兼容模式。一套静态二进制同时覆盖 CentOS 7 (3.10) ~ 最新 6.x 内核。
...
| 目标系统 | 典型内核 | 运行模式 | BTF | Ringbuf | 兼容性 |
|---------|---------|---------|-----|---------|--------|
| CentOS 7 / RHEL 7 | 3.10 | 兼容模式 | ❌ | ❌ | **✅ 支持** |
| CentOS 8 / RHEL 8 | 4.18 | 兼容模式 | ❌ | ❌ | **✅ 支持** |
| Ubuntu 20.04 | 5.4 | 兼容模式 | ⚠️ 可选 | ❌ | **✅ 支持** |
| Ubuntu 22.04+ / RHEL 9+ | 5.15+ / 5.14+ | 现代模式 | ✅ | ✅ | **✅ 支持** |
